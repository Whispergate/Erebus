...
def build_loader_config_data(
    *,
    ...
    guardrails_check_uptime: int = 0,
    guardrails_uptime_min_seconds: int = 300,
    guardrails_check_screen_resolution: int = 0,
    guardrails_check_secure_boot: int = 0,
    single_instance: int = 0,
    ...
    data = {
        ...
        "GUARDRAILS_UPTIME_MIN_SECONDS": guardrails_uptime_min_seconds,
        "GUARDRAILS_CHECK_SCREEN_RESOLUTION": guardrails_check_screen_resolution,
